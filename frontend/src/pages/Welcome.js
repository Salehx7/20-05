...
import { School, Science, Calculate, MenuBook, Biotech, Translate, Brush, Favorite, Code, Psychology } from '@mui/icons-material';
import { Box, Typography, Grid, Card, CardContent, Avatar } from '@mui/material';

const matiereIcons = {
  Maths: <Calculate style={{ color: '#1976d2' }} />,
  Physique: <Science style={{ color: '#388e3c' }} />,
  Français: <MenuBook style={{ color: '#fbc02d' }} />,
  Chimie: <Biotech style={{ color: '#e64a19' }} />,
  Anglais: <Translate style={{ color: '#0288d1' }} />,
  "Nutrition & Bien être": <Favorite style={{ color: '#d81b60' }} />,
  "Programmation(Python)": <Code style={{ color: '#512da8' }} />,
  Philosophie: <Psychology style={{ color: '#8e24aa' }} />,
  Arabe: <Translate style={{ color: '#43a047' }} />,
  "Conseils": <School style={{ color: '#ffa000' }} />,
  STI: <Code style={{ color: '#455a64' }} />,
  "Éducation Artistique": <Brush style={{ color: '#f06292' }} />,
};
